...
Make your own JRUCS Alchemy cards!

The [example](example) folder contains all the files for a JRUCS Alchemy card.  Cards start as an idea in a YAML file.  We use Visual Studio Code to edit the YAML.  GitHub Copilot sometimes has good ideas, whether set to Auto or Claude.
